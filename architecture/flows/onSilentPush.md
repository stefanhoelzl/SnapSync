# Flow — `onSilentPush` (current-state paper transcription)
...
- line 668 — `if` conditional: `if (isForging) {`
- line 673 — bare property read (lazy-init touch): `host`
- line 674 — `scope.launch` body: `scope.launch {`

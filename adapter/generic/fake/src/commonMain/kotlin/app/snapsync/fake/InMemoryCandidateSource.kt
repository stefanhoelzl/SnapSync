 ...
 * proven to work without (capability `photo-sharing`: a platform fetch can neither widen nor
...
internal class InMemoryCandidateSource(private val state: MutableStateFlow<List<RawAsset>>) : CandidateSource {
    ...
    override suspend fun candidates(policy: SelectionPolicy): CandidateRead {
        ...
        // translator does (capability `photo-sharing`) rather than reading a bound off the policy

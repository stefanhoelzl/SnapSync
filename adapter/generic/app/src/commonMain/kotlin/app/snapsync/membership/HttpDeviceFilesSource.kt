 ...
 * and answers the resources the device has stored: each **storage key**, with the `assetId` the backend
 * reported for it.
 *
 ...
 * real key is left unseeded, and the device re-uploads its entire library on the next join — with no

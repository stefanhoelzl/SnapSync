 ...
 * (capability `sync-status`, "Background entry points record protected-data state").
 *
 ...
 * (`docs/architecture.md`, "Hosts are a closed set of what changes reachable states"). That belief —

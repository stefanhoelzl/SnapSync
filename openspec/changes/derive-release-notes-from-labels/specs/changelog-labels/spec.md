# changelog-labels Specification (new)
...
told about; and a heading the committed configuration does not declare fails the derivation, because
the generator's un-configured fallback is a single ungrouped section containing *every* pull request,

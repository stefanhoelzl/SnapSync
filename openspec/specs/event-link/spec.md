...
`ConfigStore` seams, the iOS file-backed store (the App-Group config file with its written-through
Keychain copy, migration step 11a), the codec (`encodeEventUrl`/`decodeEventUrl`) that

...
logging seam; lifecycle crosses the `CrashReporting` port both shared compositions start first.
...
Decision record: `changes/archive/2026-07-21-add-crash-reporting`.

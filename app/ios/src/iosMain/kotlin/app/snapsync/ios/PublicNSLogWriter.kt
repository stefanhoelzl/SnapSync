 ...
 *
 * (Intentionally duplicated in the upload-extension module's iosMain rather than hoisted into a
 * shared core module — both leaf wiring modules already depend on Kermit, and neither shared module
 * does.)
 */

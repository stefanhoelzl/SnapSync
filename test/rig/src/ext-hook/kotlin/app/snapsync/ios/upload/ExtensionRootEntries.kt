 ...
 * through the App Group takes the place of a cycle (`docs/architecture.md`, "The device run is reached
 ...
 * `docs/architecture.md`, "Source contributed into a shell's source set is shell source for the gates"), so it

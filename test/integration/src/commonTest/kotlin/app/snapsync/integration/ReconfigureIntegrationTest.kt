...
class ReconfigureIntegrationTest {
    ...
    fun enabling_share_on_a_download_only_membership_starts_uploading_in_place() = worldTest {
        ...
        try {
            ...
            w.userCommands.reconfigure("E", Direction.Both, captureCutoff(World.DEFAULT_CUTOFF), captureCeiling(World.DEFAULT_FAR_CEILING), false)
    ...
    fun turning_receive_off_cancels_in_flight_downloads_and_imports_nothing() = worldTest {
        ...
        try {
            ...
            w.userCommands.reconfigure("E", Direction.UploadOnly, captureCutoff(World.DEFAULT_CUTOFF), captureCeiling(World.DEFAULT_FAR_CEILING), false)

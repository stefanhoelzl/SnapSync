...
/**
 * The world's in-memory [LedgerBackend] — a byte-for-byte port of the engine's `commonTest`
 * `InMemoryLedgerBackend` (which lives in `commonTest`, so a `commonMain` test-infra module cannot
 ...
 */
class WorldLedgerBackend : LedgerBackend {

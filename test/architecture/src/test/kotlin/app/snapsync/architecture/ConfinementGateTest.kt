...
class ConfinementGateTest {
    ...
    private val receivers = mapOf(
        ...
        "domain/ports/src/commonMain/kotlin/app/snapsync/ports/BackgroundEventsReceipts.kt" to
            "BackgroundEventsReceipts", // the OS's background-events completion handlers

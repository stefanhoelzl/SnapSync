...
/**
 * The **user-query bundle** (spec `module-architecture`, "Queries cross a lane-gated door"): every read the
 ...
 *   (capability `join-share-count`), or `null` when the grant permits no count. Purely local.
 */
class UserQueries(

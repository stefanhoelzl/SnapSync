...
interface CutoffFormatter {
    /** The current instant as a local wall-clock value — seeds the "Only from now" shortcut. */
    ...
    /** Parse a UTC `…Z` cutoff (the fetched `createdAt` default) back to a local value for the picker. */

...
/**
 * The App-Group persistence seam for the device manifest (capability `photo-sharing`): the JSON of
 ...
 * from the upload ledger's COMPLETED rows (capability `photo-sharing`), which already had to maintain the

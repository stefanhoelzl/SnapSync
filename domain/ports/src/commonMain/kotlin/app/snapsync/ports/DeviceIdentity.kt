...
/**
 * This install's stable device id (capability `device-identity`): the `/files/devices/<deviceId>/` byte
 ...
 * the I/O boundary named for the need", capability `module-architecture`): on device it is a Keychain read,

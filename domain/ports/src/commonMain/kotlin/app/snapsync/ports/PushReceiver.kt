 ...
 * `receiving-photos`), carrying the pushed **`eventId`** (the push payload's top-level `eventId` key,
 * capability `receiving-photos`). The iOS app-shell wiring forwards the OS's remote-notification

 ...
 *
 * Its one caller is the update-required screen's store button (capability `app-update-required`), whose
 ...
 * state (`docs/architecture.md`, "Ports are the I/O boundary named for the need").
 *
 ...
 * rather than dropped (`docs/architecture.md`, "Absence is never silent"). It suspends until the
 * platform answers.

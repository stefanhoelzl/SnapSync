...
/**
 * The **background** OS-callback trigger flow (`docs/architecture.md`, "Rules in features, order
 ...
 * later wake's tail, and by foreground (capability `receiving-photos`; decision record

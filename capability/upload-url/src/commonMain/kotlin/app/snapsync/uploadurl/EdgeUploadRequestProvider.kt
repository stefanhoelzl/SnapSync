 ...
 * partition (`/files/devices/<deviceId>/`) and linked into any number of events by reference (the per-event
 ...
 * contract: `resource.filename → files/devices/<deviceId>/<percent-encoded filename>`. The URL is
